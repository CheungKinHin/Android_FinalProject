...
public class YearlyStatisticsFragment extends Fragment {
    ...
    public YearlyStatisticsFragment() {
        // Required empty public constructor
    }

    public static YearlyStatisticsFragment newInstance() {
        return new YearlyStatisticsFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_yearly_statistics, container, false);
    }
